...
import { readApprovedRecordsFromDataDir } from './record-source.js';
 ...
 * 默认走本地文件适配器；外部适配器请用 readApprovedRecordsFromAdapters 注入。
 */
export async function readApprovedRecords(dataDir) {
  return readApprovedRecordsFromDataDir(dataDir);
}
